...
2. In **Settings → Pages**, set Branch to `main` (or `master`) and root folder `/`.
3. Open your Pages URL, e.g. `https://<username>.github.io/<repo>/`

> NOTE: All data is stored in `localStorage` of the browser (demo-grade; not secure).
